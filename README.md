...
```bash
Please download Training Dataset FFHQ ([https://github.com/NVlabs/ffhq-dataset](https://github.com/NVlabs/ffhq-dataset)), then place it in the project root directory.
