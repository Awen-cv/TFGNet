...
from models.basicsr.data import gaussian_kernels
from models.basicsr.data.transforms import augment
from models.basicsr.data.data_util import paths_from_folder
...
class FFHQBlindJointDataset(data.Dataset):
    def __init__(self, opt):
        ...
        # Load components and latent ground truth if provided
